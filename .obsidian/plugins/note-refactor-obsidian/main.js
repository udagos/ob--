...
var NoteRefactorSettingsTab = /** @class */ (function (_super) {
    ...
    NoteRefactorSettingsTab.prototype.display = function () {
        ...
        new obsidian.Setting(containerEl)
            ...
            return dropDown
                .addOption(Location[Location.VaultFolder], "库文件夹")
                .addOption(Location[Location.SameFolder], "与当前文件同文件夹")
                .addOption(Location[Location.SpecifiedFolder], "在下面指定的文件夹中")
        ...
        new obsidian.Setting(containerEl)
            ...
            .addTextArea(function (text) {
            text
                .setPlaceholder("示例: {{date:YYYYMMDDHHmm}}-")
        ...
        new obsidian.Setting(containerEl)
            .setName('默认情况下进行转录')
            .setDesc('当内容被提取/拆分为新笔记时，请包含新笔记的摘要')
        ...
        new obsidian.Setting(containerEl)
            .setName('笔记链接模板')
            .setDesc(this.tempalteDescriptionContent('用于生成指向提取笔记的链接的模板。这将覆盖“默认转录”设置。'))
            .addTextArea(function (text) {
            text
        ...
        new obsidian.Setting(containerEl)
            .setName('重构笔记模板')
            .setDesc(this.tempalteDescriptionContent('用于生成重构笔记内容的模板。'))
            .addTextArea(function (text) {
            text
        ...
        new obsidian.Setting(containerEl)
            .setName('排除第一行')
            .setDesc('防止所选/拆分注释内容的第一行包含在新注释中（仅适用于作为文件名命令的第一行）')
        ...
        new obsidian.Setting(containerEl)
            .setName('包括标题')
            .setDesc('将所选/拆分笔记内容的第一行作为笔记标题（适用于第一行作为标题和仅内容命令）')
        ...
        new obsidian.Setting(containerEl)
            .setName('使标题级别标准化')
            .setDesc('当内容被提取/拆分为新注释时，对标题的级别进行标准化')
    ...
    NoteRefactorSettingsTab.prototype.filenamePrefixDescriptionContent = function () {
        var descEl = document.createDocumentFragment();
        descEl.appendText('新创建的笔记将具有此前缀');
        descEl.appendChild(document.createElement('br'));
        this.dateFormattingDescription(descEl);
        descEl.appendText('您当前的文件名前缀语法如下：');
        descEl.appendChild(document.createElement('br'));
    ...
    NoteRefactorSettingsTab.prototype.dateFormattingDescription = function (descEl) {
        descEl.appendText('支持日期格式{{date:YYYYMMDDHHmm}}');
        descEl.appendChild(document.createElement('br'));
        descEl.appendText('并在创建注释时与当前日期和时间一起使用。');
        descEl.appendChild(document.createElement('br'));
        descEl.appendText('有关更多语法，请参阅 ');
