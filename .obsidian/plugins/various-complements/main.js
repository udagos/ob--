...
var VariousComplementsSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  async addMainSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("策略").addDropdown(
    ...
    if (this.plugin.settings.strategy === TokenizeStrategy.CHINESE.name) {
      ...
      new import_obsidian3.Setting(containerEl).setName("CC-CEDICT路径").setDesc(df).setClass("various-complements__settings__nested").addText((cb) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("匹配策略").addDropdown(
    ...
    new import_obsidian3.Setting(containerEl).setName("模糊匹配").addToggle((tc) => {
      tc.setValue(this.plugin.settings.fuzzyMatch).onChange(async (value) => {
        this.plugin.settings.fuzzyMatch = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian3.Setting(containerEl).setName("最小模糊匹配分数").setDesc("仅显示模糊匹配分数高于特定值的建议。").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("将重音符号视为字母字符。").setDesc("例：如果启用，'aaa'会匹配'áäā'").addToggle((tc) => {
      tc.setValue(
    ...
    if (TokenizeStrategy.fromName(this.plugin.settings.strategy).canTreatUnderscoreAsPartOfWord) {
      new import_obsidian3.Setting(containerEl).setName("将下划线视为单词的一部分。").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("不含表情符号的匹配").setDesc("例：如果启用，'aaa'会匹配'😀aaa'").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("最大建议数量").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("作为短语的最大单词数").setDesc(`[⚠警告] 它会使速度变慢N倍以上（N是设置值）`).addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("触发的最小字符数").setDesc("将值设为0并不意味着无需输入任何字符就会触发建议。相反，会根据您选择的策略使用指定的值。").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("触发的最小单词数").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("自动补全").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("触发延迟毫秒数").addSlider(
    ...
    new import_obsidian3.Setting(containerEl).setName("在IME开启时禁用建议").addToggle((tc) => {
      tc.setValue(
    ...
    new import_obsidian3.Setting(containerEl).setName("禁用数学块中的建议").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("补全后插入空格").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("禁用建议的首字符").addText((cb) => {
      cb.setValue(
    ...
    new import_obsidian3.Setting(containerEl).setName("抑制触发的行模式").setDesc("抑制自动完成激活的正则表达式行模式（部分匹配）直到光标位置。可以用换行定义多个模式。").addTextArea((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("抑制触发的短语模式").setDesc("抑制自动完成激活的正则表达式模式（精确匹配）。可以用换行定义多个模式。").addTextArea((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("循环前不自动聚焦").setDesc("在按下循环键之前不聚焦于建议。").addToggle((tc) => {
  ...
  addAppearanceSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("显示匹配策略").setDesc("在状态栏显示匹配策略。更改此选项需要重启才能生效。").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("显示自动补全").setDesc("在状态栏自动显示补全。更改此选项需要重启才能生效。").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("显示索引状态").setDesc("在状态栏显示索引状态。更改此选项需要重启才能生效。").addToggle((tc) => {
    ...
    new import_obsidian3.Setting(containerEl).setName("建议的描述").addDropdown(
      (tc) => tc.addOptions(
  ...
  addKeyCustomizationSettings(containerEl) {
    ...
    const df = document.createDocumentFragment();
    df.append(ul);
    new import_obsidian3.Setting(div).setHeading().setName("热键").setDesc(df);
    ...
    new import_obsidian3.Setting(containerEl).setName("传播ESC").setDesc("如果您使用Vim模式，这很方便，因为无论是否显示建议，您都可以通过一次ESC切换到普通模式。").addToggle((tc) => {
  ...
  addCurrentFileComplementSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("启用当前文件补全").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableCurrentFileComplement) {
      new import_obsidian3.Setting(containerEl).setName("索引的最小字符数").setDesc("如果设置为0，则使用策略的默认值。").addSlider(
      ...
      new import_obsidian3.Setting(containerEl).setName("当前文件补全仅补全英文").addToggle((tc) => {
        tc.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("触发的最小字符数").setDesc(
      ...
      new import_obsidian3.Setting(containerEl).setName("排除用于索引的单词模式").setDesc(
  ...
  addCurrentVaultComplementSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("启用当前保险库补全").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableCurrentVaultComplement) {
      ...
      new import_obsidian3.Setting(containerEl).setName("包含前缀路径模式").setDesc("用于包含文件的前缀匹配路径模式。").addTextArea((tac) => {
      ...
      new import_obsidian3.Setting(containerEl).setName("排除前缀路径模式").setDesc("用于排除文件的前缀匹配路径模式。").addTextArea((tac) => {
        const el = tac.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("仅包含当前目录下的文件").addToggle((tc) => {
        tc.setValue(
  ...
  addCustomDictionaryComplementSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("启用自定义词典补全").addToggle((tc) => {
      tc.setValue(
    ...
    if (this.plugin.settings.enableCustomDictionaryComplement) {
      new import_obsidian3.Setting(containerEl).setName("自定义词典路径").setDesc("为每行指定从保险库根目录的相对路径或URL。" ).addTextArea((tac) => {
      ...
      new import_obsidian3.Setting(containerEl).setName("列分隔符").addDropdown(
      ...
      new import_obsidian3.Setting(containerEl).setName("单词正则表达式模式").setDesc("只加载匹配正则表达式模式的单词。").addText((cb) => {
        cb.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("隐藏建议的分隔符").setDesc("如果设置为';;;'，'abcd;;;efg'在建议中显示为'abcd'，但补全为'abcdefg'。").addText((cb) => {
      ...
      new import_obsidian3.Setting(containerEl).setName("用于分隔显示建议和插入建议的分隔符").setDesc("如果设置为' >>> '，'displayed >>> inserted'在建议中显示为'displayed'，但补全为'inserted'。").addText((cb) => {
        cb.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("补全后的插入符号位置").setDesc("如果设置为'<CARET>'，且自定义词典中有'<li><CARET></li>'，它会补全为'<li></li>'并将光标移动到'<li>'和'</li>'之间。").addText((cb) => {
        cb.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("显示文本后缀").setDesc("如果显示的文本和插入的文本有差异，它会作为显示文本的后缀显示").addText((cb) => {
  ...
  addInternalLinkComplementSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("启用内部链接补全").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableInternalLinkComplement) {
      new import_obsidian3.Setting(containerEl).setName("使用别名建议").addToggle((tc) => {
        tc.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("保存时更新内部链接").addToggle((tc) => {
      ...
      new import_obsidian3.Setting(containerEl).setName("插入从显示的内部链接转换而来的别名").addToggle((tc) => {
        tc.setValue(
      ...
      if (this.plugin.settings.insertAliasTransformedFromDisplayedInternalLink.enabled) {
        new import_obsidian3.Setting(containerEl).setName("之前：带捕获的正则表达式模式").setDesc(String.raw`Ex: (?<name>.+) \(.+\)$`).setClass("various-complements__settings__nested").addText((cb) => {
          cb.setValue(
        ...
        new import_obsidian3.Setting(containerEl).setName("之后").setDesc("例：$<name>").setClass("various-complements__settings__nested").addText((cb) => {
          cb.setValue(
      ...
      new import_obsidian3.Setting(containerEl).setName("用于排除的前置元数据键").setDesc("如果前置元数据中有与此设置同名的键，且值为'true'，则从建议中排除内部链接").addText((cb) => {
        TextComponentEvent.onChange(cb, async (value) => {
  ...
  addFrontMatterComplementSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("启用前置元数据补全").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableFrontMatterComplement) {
      new import_obsidian3.Setting(containerEl).setName("前置元数据中的匹配策略").addDropdown(
        (tc) => tc.addOptions(
      ...
      new import_obsidian3.Setting(containerEl).setName("补全后插入逗号").addToggle((tc) => {
        tc.setValue(
  ...
  addIntelligentSuggestionPrioritizationSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("启用智能建议优先级").addToggle((tc) => {
      tc.setValue(
    ...
    if (this.plugin.settings.intelligentSuggestionPrioritization.enabled) {
      new import_obsidian3.Setting(containerEl).setName("历史文件路径").setDesc(`默认：${DEFAULT_HISTORIES_PATH}`).addText((cb) => {
        TextComponentEvent.onChange(cb, async (value) => {
      ...
      new import_obsidian3.Setting(containerEl).setName("保留历史的最大天数").setDesc("如果设置为0，将永不删除").addSlider(
      ...
      new import_obsidian3.Setting(containerEl).setName("保留的最大历史数量").setDesc("如果设置为0，将永不删除").addSlider(
  ...
  addMobileSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("在移动设备上禁用").addToggle((tc) => {
  ...
  addDebugSettings(containerEl) {
    ...
    new import_obsidian3.Setting(containerEl).setName("在控制台中显示性能日志").addToggle((tc) => {
      tc.setValue(
...
function open(popup) {
  ...
  if (!markdownFile) {
    new import_obsidian6.Notice(`无法打开 ${item.createdPath}`);
    return false;
  }
